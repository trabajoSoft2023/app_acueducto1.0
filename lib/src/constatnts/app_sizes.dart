...
/// Tamaños constantes que se utilizarán en la aplicación (rellenos, espacios, esquinas redondeadas, etc.)
class Sizes {
  static const p4 = 4.0;
  static const p8 = 8.0;
